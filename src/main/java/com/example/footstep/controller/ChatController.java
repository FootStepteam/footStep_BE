...
import com.example.footstep.domain.dto.chat.ChatDto;
...
public class ChatController {
    ...
    public ResponseEntity<ArrayList<String>> userList(String roomId) {
        return ResponseEntity.ok(chatService.getUserList(roomId));
    }

    // 채팅에 참여한 유저 닉네임 중복 확인
    @GetMapping("/chat/duplicateName")
    public ResponseEntity<String> isDuplicateName(@RequestParam("roomId") String roomId, @RequestParam("username") String username) {
